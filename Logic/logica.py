    ...
    try:
        if seleccion == '1':
            ...
            if nombre == "" or precio <= 0 or categoria == "":
                print(Fore.RED + "Error: Todos los campos son obligatorios y el precio debe ser mayor a cero.")
                time.sleep(2)
                os.system('cls' if os.name == 'nt' else 'clear')
                ver_menu()
            else:
            ...
            if not id_producto or id_producto <= 0 or id_producto == "" or id_producto is None:
                print(Fore.RED + "Error: El ID del producto es obligatorio.")
                time.sleep(2)
                os.system('cls' if os.name == 'nt' else 'clear')
                ver_menu()
            else:
        ...
        print(Fore.RED + f"Error al procesar la selección del menú: {e}")
        time.sleep(2)
        os.system('cls' if os.name == 'nt' else 'clear')
        ver_menu()
    finally:
